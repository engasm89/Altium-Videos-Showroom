...
export const ProjectHubView: React.FC<ProjectHubViewProps> = ({ onSelectTutorial }) => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 text-slate-100">
      ...
      <div className="space-y-3">
        ...
        <h2 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight">
          Complete Hardware Electronics Projects
        </h2>
        <p className="text-slate-300 text-sm sm:text-base max-w-3xl leading-relaxed">
          Learn by building real physical hardware. Each project hub connects schematic capture, component library setup, PCB layout, DRC validation, and manufacturing release outputs.
        </p>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-1">
                    ...
                    <h3 className="text-xl font-bold text-white pt-1">{proj.title}</h3>
                ...
                {/* Linked Project Tutorials Sequence */}
